...
public class Services {
	...
	public static void sendMail(String emailid,int value){
		final String username  = "nitinkumar1860@gmail.com";//Sender Email
		final String password   = "dusnsedgpwukydro";//Sender Password
		...
		try {
			...
			message.setText("Dear User ,"+ "\n\n Your OTP For Forgot Password is :"+value);
