                        ...
                        <div class="row">
                         ...
                         <option value="seller">Seller</option>
                           ...
                           <div class="col-md-6 col-sm-6">
                              <input class="contactus" placeholder="First Name" type="text" name="fname"> 
                           </div>
                           <div class="col-md-6 col-sm-6">
                              <input class="contactus" placeholder="Last Name" type="text" name="lname"> 
                           </div>
                           <div class="col-md-6 col-sm-6">
                              <input class="contactus" placeholder="Mobile Number" type="text" name="mobile"> 
                           </div>
                           <div class="col-md-6 col-sm-6">
                           ...
                           <div class="col-md-12">
                              <button class="send_btn" type="submit" name="action" value="Sign up">Sign Up</button>
                           </div>
                        </div>
                     </form>
                  </div>
